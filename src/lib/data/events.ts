...
import { fetchLiveEvents } from "@/lib/external/gdelt";
...
export async function getEvents(): Promise<Event[]> {
  ...
  // GDELT has no SLA — fall back to mock events rather than showing an
  // empty state if the live fetch comes back empty.
